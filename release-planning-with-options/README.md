# Release Planning with Options

## Summary/Description

This app is similar to the Release Planning page with options to change the way estimates are calculated.

![screenshot](./images/screenshot.png "App")

You may change the estimate type using the app settings.

![screenshot](./images/screenshot-app-settings.png "App Settings")
