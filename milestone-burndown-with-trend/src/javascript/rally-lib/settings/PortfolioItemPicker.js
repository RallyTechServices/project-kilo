(function () {
    ...
    Ext.define("Rally.apps.charts.settings.PortfolioItemPicker", {
        ...
        emptyText: '<p>No Milestones match your search criteria.</p>',
        ...
        _getChooserConfig: function () {
            return {
                ...
                multiple: true,
                height: 350,
                title: 'Choose Milestone(s) to Add',
                closeAction: 'destroy',
                ...
                storeConfig: {
                    project: null,
                    context: this.requestContext,
                    fetch: ['ObjectID','Project','WorkSpace','FormattedID','Name','ActualStartDate','PlannedStartDate','ActualEndDate','PlannedEndDate','TargetDate']
                },
                gridConfig: {
                    viewConfig: {
